...
def generate_scs(events_txt_path: str, day_of_observation: int, output_path: str, pre_path: str, post_path: str) -> None:
...
def main() -> None:
    ...
    generate_scs(args.events_txt, day_of_observation, out_path, args.pre, args.post)
